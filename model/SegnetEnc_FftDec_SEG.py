...
class SegnetEncS(nn.Module):
    def __init__(self, n_channels=32, BN_momentum=0.5, n_classes=3, segmentation_head=True):
        super(SegnetEncS, self).__init__()
    ...
    def forward(self, x):
        # Pass input through theSegNet encoder
