...
from .network.backbone.resnet_encoder import resnet18
...
class RangeAngle_Decoder(nn.Module):
    def __init__(self, ):
        ...
        self.L3 = nn.Conv2d(512, 224, kernel_size=1, stride=1, padding=0)
        self.L2 = nn.Conv2d(256, 224, kernel_size=1, stride=1, padding=0)
