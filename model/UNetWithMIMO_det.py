...
class UNetWithMIMO(nn.Module):
    def __init__(self, n_channels=32, n_classes=1, bilinear=False,segmentation_head=False,detection_head=True):
        ...
        input_dims = (512, 256)  # Example dimensions, adjust based on actual use
    ...
    def forward(self, x):
        ...
        #     x=self.segmentation_head(unet_output)
