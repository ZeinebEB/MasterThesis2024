...
class Metrics():
    ...
    def updateSEG(self,PredMap,label_map):
    ...
    def updateDET(self,ObjectPred,Objectlabels,threshold=0.2,range_min=5,range_max=70):
    ...
    def GetMetrics(self,detection_loss,segmentation_loss):
        precision=0
        recall=0
        mIoU=0
